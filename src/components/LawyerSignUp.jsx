          ...
          <div className="grid grid-cols-3 gap-10 pt-14 items-center justify-center text-black p-4">
              ...
              <div className="w-full col-span-2 max-w-xs p-5 z-101 ">
                ...
                <form className="space-y-4">
                  ...
                  <button className="w-full bg-blue-600 p-3 rounded-lg text-black font-medium hover:bg-blue-700">Sign Up</button>
                </form>
    
                <p className="text-center text-gray-400 mt-4">
                  Do you have an account? <span className="text-[#C99F4A] cursor-pointer"><Link to="../LawyerSignIn">Sign In</Link></span>
                </p>
              </div>
            </div>
          </div>
