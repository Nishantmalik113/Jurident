...
import { Files, PlusCircle, Users, FileText, Calendar, HelpCircle, Settings, AppWindow } from 'lucide-react';
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 justify-center items-center ml-18 mr-18 px-10 mb-6">
          <div className='pl-7 pr-7'>
            <Link to="/allcases" className="bg-gray-800 rounded-lg p-6 flex items-center space-x-4 hover:bg-gray-700 transition ">
          ...
          <div className='pl-7 pr-7'>
          <Link to="/addcase" className="bg-gray-800 rounded-lg p-6 flex items-center space-x-4 hover:bg-gray-700 transition">
          ...
          <div className='pl-7 pr-7'>
          <Link to="/MyTeams" className="bg-gray-800 rounded-lg p-6 flex items-center space-x-4 hover:bg-gray-700 transition">
          ...
          <div className='pl-7 pr-7'>
          <Link to="/sharedcases" className="bg-gray-800 rounded-lg p-6 flex items-center space-x-4 hover:bg-gray-700 transition">
          ...
          <div className='pl-7 pr-7'>
          <Link to="/juridentassistence" className="bg-gray-800 rounded-lg p-6 flex items-center space-x-4 hover:bg-gray-700 transition">
          ...
          <div className='pl-7 pr-7'>
          <Link to="/fileuploading" className="bg-gray-800 rounded-lg p-6 flex items-center space-x-4 hover:bg-gray-700 transition">
